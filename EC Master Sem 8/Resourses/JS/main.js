...
//  increment counter effect start
var project = setInterval(projectdone, 10)
var view = setInterval(views, 10)
var leader = setInterval(leaders, 10)
var material = setInterval(materials, 10)
let count1 = 1;
let count2 = 1;
let count3 = 1;
let count4 = 1;
...
function materials()
{
     ...
     if(count4==79)
     {
          clearInterval(material)
     }
}
//  increment counter effect end==================>
